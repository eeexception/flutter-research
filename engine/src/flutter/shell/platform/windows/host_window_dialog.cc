...
HostWindowDialog::HostWindowDialog(WindowManager* window_manager,
  ...
  DWORD const window_style = GetWindowStyleForDialog(owner_window, resizable);
  DWORD const extended_window_style =
